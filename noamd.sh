#!/bin/bash
# Script Post-Instalación Fedora (dnf5)
...
# 8. Reemplazar LibreOffice por ONLYOFFICE (Flatpak)
sudo dnf remove libreoffice* -y
sudo flatpak install -y flathub org.onlyoffice.desktopeditors

# 9. Reemplazar Firefox por Brave Browser
